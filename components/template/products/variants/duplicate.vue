...
<template>
  <ModalTitleButton title="Add Variant" v-model="modal" @send="duplicateVariant" width="min-w-full  sm:min-w-[600px] md:min-w-[760px] lg:min-w-[992px] xl:min-w-[1024px]">
